...
export function CreditCardDebtForm({ onNext, onBack }: CreditCardDebtFormProps) {
  const { formData, updateFormData, saveFieldProgress } = useFormContext()
  ...
  const handleDebtResponse = (hasDebt: boolean) => {
    ...
    if (!hasDebt) {
      // Even if they don't have debt, still move to the next offer (personal loans)
      onNext()
    }
  }
  ...
  return (
    <div className="max-w-md mx-auto">
      <ProgressBar currentStep={5} totalSteps={12} label="Profile 42% Complete" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 text-white flex items-center justify-center font-bold mr-3">
                S
              </div>
              <div>
